...
def lambda_handler(event, context):
    ...
    if event:
        ...
        file_url = "http://fit5225assignment2.s3.amazonaws.com/" + file_name
        
        coco_names = s3.get_object(Bucket = "fit5225assignment2", Key = "coco.names")
        ...
        s3.download_file(Bucket = "fit5225assignment2", Key = "yolov3-tiny.weights", Filename="/tmp/yolov3.weights")
        s3.download_file(Bucket = "fit5225assignment2", Key = "yolov3-tiny.cfg", Filename="/tmp/yolov3.cfg")
        
        image_obj = s3.get_object(Bucket = "fit5225assignment2", Key = file_name)
        ...
        dynamodb.put_item(
            TableName="fit5225assignment2dynamodb", 
            Item={
                'image_url': {
                    'S': file_url,
                }, 
